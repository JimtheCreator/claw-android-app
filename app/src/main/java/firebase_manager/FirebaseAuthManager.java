...
public class FirebaseAuthManager {
    ...
    public User getUserData(){
        FirebaseDatabase.getInstance().getReference().child("users").child(getCurrentUser().getUid()).addValueEventListener(new ValueEventListener() {
            @Override
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Log.e("FirebaseAuthManager", "Error fetching user data from Firebase");
            }
        });
        return user;
    }
